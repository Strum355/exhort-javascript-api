...
import { getCustomPath, handleSpacesInPath, invokeCommand } from "../tools.js";
...
var npmInteractions = {
	listing: function runNpmListing(npm, manifestDir, includeAll) {
		invokeCommand(npm, ['ls', includeAll ? '--all' : '', '--omit=dev', '--package-lock-only', '--json', '--prefix', manifestDir], error => {
